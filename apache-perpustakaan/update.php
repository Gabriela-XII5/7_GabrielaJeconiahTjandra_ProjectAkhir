...
if(isset($_POST['ubah'])) {
    ...
    $query= "update buku set gambar='$gambar', penulis='$penulis', judul='$judul', tempat_terbit='$tempat', penerbit='$penerbit', tahun_terbit='$tahun', halaman='$halaman' where id='$id'";
    ...
    while($k = mysqli_fetch_array($buku)){
        ...
        <div class="card shadow-sm mx-auto" style="max-width: 700px;">
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label class="form-label">Cover (.jpg)</label>
                    <input type="text" class="form-control" name="gambar" placeholder="Masukkan link gambar" value="<?php echo $k['gambar']; ?>" required>
                </div>
                <div class="mb-3">
